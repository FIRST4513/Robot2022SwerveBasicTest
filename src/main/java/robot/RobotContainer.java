...
import robot.commands.autoTestCmdGrp;
import robot.commands.driveByJoystickCmd;
import robot.commands.driveGyroResetCmd;
import robot.commands.driveResetOdometryCmd;
...
private final Joystick driverJoy = new Joystick(0);
  ...
  */
  private RobotContainer() {
    ...
    SmartDashboard.putData("Autonomous Test Command Group", new autoTestCmdGrp());
    ...
    m_drivetrainSubSys.setDefaultCommand(new driveByJoystickCmd( m_drivetrainSubSys ) );
...
//    m_chooser.addOption("Auto 1 Cmd", new auto1Cmd( m_drivetrainSubSys ));
    ...
    SmartDashboard.putData("Reset Odo", new driveResetOdometryCmd(m_drivetrainSubSys));
    SmartDashboard.putData("Reset Gyro", new driveGyroResetCmd(m_drivetrainSubSys));
  }
  ...
  public Command getAutonomousCommand() {
    ...
    Trajectory trajectory = TrajectoryGenerator.generateTrajectory(
          ...
          List.of(
                  ...
                  new Translation2d(Units.inchesToMeters(24.0), Units.inchesToMeters(24.0))),
          new Pose2d(Units.inchesToMeters(48), Units.inchesToMeters(24.0), Rotation2d.fromDegrees(45)),
          trajectoryConfig);
